...
bool ro45_portalrobot_interfaces__msg__robot_pos__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ro45_portalrobot_interfaces.msg._robot_pos.RobotPos", full_classname_dest, 51) == 0);
  }
  ro45_portalrobot_interfaces__msg__RobotPos * ros_message = _ros_message;
  {  // pos_x
...
PyObject * ro45_portalrobot_interfaces__msg__robot_pos__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ro45_portalrobot_interfaces.msg._robot_pos");
