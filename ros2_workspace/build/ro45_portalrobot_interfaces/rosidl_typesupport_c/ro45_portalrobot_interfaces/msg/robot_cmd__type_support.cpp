...
static const _RobotCmd_type_support_symbol_names_t _RobotCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ro45_portalrobot_interfaces, msg, RobotCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ro45_portalrobot_interfaces, msg, RobotCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ro45_portalrobot_interfaces, msg, RobotCmd)() {
  return &::ro45_portalrobot_interfaces::msg::rosidl_typesupport_c::RobotCmd_message_type_support_handle;
}
