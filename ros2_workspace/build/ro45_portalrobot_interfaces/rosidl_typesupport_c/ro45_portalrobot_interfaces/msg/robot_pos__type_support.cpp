...
static const _RobotPos_type_support_symbol_names_t _RobotPos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ro45_portalrobot_interfaces, msg, RobotPos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ro45_portalrobot_interfaces, msg, RobotPos)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ro45_portalrobot_interfaces, msg, RobotPos)() {
  return &::ro45_portalrobot_interfaces::msg::rosidl_typesupport_c::RobotPos_message_type_support_handle;
}
