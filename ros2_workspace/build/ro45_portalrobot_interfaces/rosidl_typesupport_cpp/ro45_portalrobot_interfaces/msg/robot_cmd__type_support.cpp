...
static const _RobotCmd_type_support_symbol_names_t _RobotCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ro45_portalrobot_interfaces, msg, RobotCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ro45_portalrobot_interfaces, msg, RobotCmd)),
  }
};
...
{
  return &::ro45_portalrobot_interfaces::msg::rosidl_typesupport_cpp::RobotCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ro45_portalrobot_interfaces, msg, RobotCmd)() {
  return get_message_type_support_handle<ro45_portalrobot_interfaces::msg::RobotCmd>();
}
