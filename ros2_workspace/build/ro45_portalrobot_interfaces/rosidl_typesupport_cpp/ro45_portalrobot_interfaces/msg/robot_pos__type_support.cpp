...
static const _RobotPos_type_support_symbol_names_t _RobotPos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ro45_portalrobot_interfaces, msg, RobotPos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ro45_portalrobot_interfaces, msg, RobotPos)),
  }
};
...
{
  return &::ro45_portalrobot_interfaces::msg::rosidl_typesupport_cpp::RobotPos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ro45_portalrobot_interfaces, msg, RobotPos)() {
  return get_message_type_support_handle<ro45_portalrobot_interfaces::msg::RobotPos>();
}
