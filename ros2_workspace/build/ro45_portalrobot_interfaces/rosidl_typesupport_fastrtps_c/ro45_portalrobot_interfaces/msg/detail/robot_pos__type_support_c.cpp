...
#include "ro45_portalrobot_interfaces/msg/detail/robot_pos__rosidl_typesupport_fastrtps_c.h"
...
using _RobotPos__ros_msg_type = ro45_portalrobot_interfaces__msg__RobotPos;
...
size_t get_serialized_size_ro45_portalrobot_interfaces__msg__RobotPos(
  const void * untyped_ros_message,
...
static uint32_t _RobotPos__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ro45_portalrobot_interfaces__msg__RobotPos(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ro45_portalrobot_interfaces
size_t max_serialized_size_ro45_portalrobot_interfaces__msg__RobotPos(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RobotPos__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ro45_portalrobot_interfaces__msg__RobotPos(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ro45_portalrobot_interfaces, msg, RobotPos)() {
