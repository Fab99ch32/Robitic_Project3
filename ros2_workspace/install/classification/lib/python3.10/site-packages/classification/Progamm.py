...
from portal_robot_interfaces.msg import IdSample, IdClass
...
class ObjectClassification(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(IdSample, 'IdSamples', self.image_callback, 10)
        self.publisher = self.create_publisher(IdClass, 'IdClass', 10)
